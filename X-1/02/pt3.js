...
// ... Once you have created the `SlashCommandUserOption` object, you can pass it to the `addUserOption()` method like this:
slashCommand.addUserOption(winnerUserOption);
