...
// ... Once you have created the `SlashCommandRoleOption` object, you can pass it to the `addRoleOption()` method like this:

slashCommand.addRoleOption(winnerRoleOption);
